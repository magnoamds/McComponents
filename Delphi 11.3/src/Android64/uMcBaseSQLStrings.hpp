...
// (DO NOT EDIT: machine generated header) 'uMcBaseSQLStrings.pas' rev: 35.00 (Android)
...
public:
	...
	/* TStringList.Create */ inline __fastcall TMcSQLStrings(System::Types::TDuplicates Duplicates, bool Sorted, bool CaseSensitive)/* overload */ : System::Classes::TStringList(Duplicates, Sorted, CaseSensitive) { }
