...
// (DO NOT EDIT: machine generated header) 'uMcServerContract.pas' rev: 35.00 (Android)
...
{
	virtual System::UnicodeString __fastcall Resource(Umcjsoncontract::_di_IMcJSONObject AJSONObject) = 0 ;
};
